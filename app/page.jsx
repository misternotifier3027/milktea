    ...
    return (
        loading ? (
            ...
            <div className="lg:w-2/3 w-full mx-auto">
                            ...
                            card.length > 0 ? (
                                <div>
                                    <div className="flex justify-between">
                                        ...
                                        <svg onClick={() => setClearCard(true)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 cursor-pointer hover:text-red">
                ...
                {clearCard && (
                    <div tabindex="-1" className="overflow-y-auto overflow-x-hidden fixed bottom-0 right-0 left-0 z-50 justify-center items-center w-full h-full bg-opacity-30 bg-black">
                        <div className="relative m-auto mt-40 w-full max-w-md max-h-full">
                            <div className="relative bg-white rounded-lg shadow-md dark:bg-bodydark">
                                <button onClick={() => setClearCard(false)} type="button" className="absolute top-3 right-2.5 text-black bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600" >
                                ...
                                <div className="p-6 text-center">
                                    <h3 className="mb-5 text-lg font-normal text-black">Xóa toàn bộ giỏ hàng?</h3>
                                    <div className="flex justify-around">
                                        <button onClick={() => {updateCard([]); setClearCard(false)}} type="button" className="text-white bg-red hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                            Xóa
                                        </button>
                                        <button onClick={() => setClearCard(false)} type="button" className=" dark:bg-bodydark1 text-black focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border text-sm font-medium px-5 py-2.5 focus:z-10 ">Hủy</button>
                                    </div>
